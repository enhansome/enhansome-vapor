...
* ![v3](img/vapor-3.png) [SwifQL](https://github.com/MihaelIsaev/SwifQL) ⭐ 300 | 🐛 6 | 🌐 Swift | 📅 2025-02-12 – Easily build flexible and type-safe SQL with pure Swift.
...
* ![v3](img/vapor-3.png) [Vapor Mailgun Service](https://github.com/vapor-community/VaporMailgunService) ⭐ 124 | 🐛 10 | 🌐 Swift | 📅 2026-08-19 – A service to be used with Vapor to send emails.
...
* ![v3](img/vapor-3.png) [Leaf Markdown](https://github.com/vapor-community/leaf-markdown) ⭐ 64 | 🐛 0 | 🌐 Swift | 📅 2026-07-28 – Markdown renderer for Vapor.
* ![v3](img/vapor-3.png) [APNS](https://github.com/vapor-community/apns) ⚠️ Archived – Vapor APNS for iOS.
* ![v3](img/vapor-3.png) [Lingo Vapor](https://github.com/vapor-community/Lingo-Vapor) ⭐ 59 | 🐛 1 | 🌐 Swift | 📅 2022-10-29 – Vapor provider for Lingo – the Swift localization library.
* ![v3](img/vapor-3.png) [Google Cloud Provider](https://github.com/vapor-community/google-cloud-provider) ⭐ 48 | 🐛 1 | 🌐 Swift | 📅 2024-06-18 – Interact with Google Cloud Platform APIs from your Vapor project.
* ![v3](img/vapor-3.png) [CSRF](https://github.com/vapor-community/CSRF) ⭐ 44 | 🐛 2 | 🌐 Swift | 📅 2022-12-23 – A package to add protection to Vapor against CSRF attacks.
* ![v3](img/vapor-3.png) [JWT Keychain](https://github.com/nodes-vapor/jwt-keychain) ⚠️ Archived – Easily scaffold a keychain using JWT for Vapor.
* ![v3](img/vapor-3.png) [Bugsnag](https://github.com/nodes-vapor/bugsnag) ⚠️ Archived – Report errors with Bugsnag.
* ![v3](img/vapor-3.png) [WKHTMLTOPDF](https://github.com/MihaelIsaev/wkhtmltopdf) ⭐ 39 | 🐛 3 | 🌐 Swift | 📅 2020-06-07 – Build PDF files from Leaf templates or web pages through the `wkhtmltopdf` CLI tool.
* ![v3](img/vapor-3.png) [Flash](https://github.com/nodes-vapor/flash) ⚠️ Archived – Flash messages between views.
* ![v3](img/vapor-3.png) [JWT Middleware](https://github.com/skelpo/JWTMiddleware) ⭐ 37 | 🐛 3 | 🌐 Swift | 📅 2021-10-20 – Middleware to Authenticate and Authorize Requests in Vapor.
* ![v3](img/vapor-3.png) [VaporExt](https://github.com/vapor-community/vapor-ext) ⭐ 36 | 🐛 1 | 🌐 Swift | 📅 2019-05-06 – A collection of Swift extensions for wide range of Vapor data types and classes.
* ![v3](img/vapor-3.png) [API Error Middleware](https://github.com/skelpo/APIErrorMiddleware) ⭐ 35 | 🐛 1 | 🌐 Swift | 📅 2018-07-24 – Vapor middleware for converting thrown errors to JSON responses.
* ![v3](img/vapor-3.png) [Vapor Test Tools](https://github.com/LiveUI/VaporTestTools) ⭐ 34 | 🐛 1 | 🌐 Swift | 📅 2020-12-20 – Helper designed to make testing your endpoints in Vapor 3 pain-free.
...
* ![v3](img/vapor-3.png) [Vapor reCAPTCHA](https://github.com/gotranseo/vapor-recaptcha) ⭐ 15 | 🐛 0 | 🌐 Swift | 📅 2018-05-08 – Validate Google reCAPTCHAs using Vapor.
* ![v3](img/vapor-3.png) [Submissions](https://github.com/nodes-vapor/submissions) ⚠️ Archived – Conveniences for creating forms and validating (form) submissions.
* ![v3](img/vapor-3.png) [XMLCoding](https://github.com/LiveUI/XMLCoding) ⭐ 11 | 🐛 2 | 🌐 Swift | 📅 2025-08-25 – XML encoder and decoder.
* ![v3](img/vapor-3.png) [S3 Storage](https://github.com/anthonycastelli/s3-storage) ⭐ 10 | 🐛 0 | 🌐 Swift | 📅 2018-05-10 – Library for simple access to the Amazon S3 service.
* ![v3](img/vapor-3.png) [Telesign Provider](https://github.com/vapor-community/telesign-provider) ⭐ 10 | 🐛 2 | 🌐 Swift | 📅 2026-03-07 – A Telesign provider for Vapor.
* ![v3](img/vapor-3.png) [Vapor Request Storage](https://github.com/skelpo/vapor-request-storage) ⭐ 7 | 🐛 0 | 🌐 Swift | 📅 2018-05-09 – A replacement for `request.storage` which was available in Vapor 1 & 2.
* ![v3](img/vapor-3.png) [Local Storage](https://github.com/gperdomor/local-storage) ⚠️ Archived – Storage driver using local filesystem.

## Tools

* [Sourcery](https://github.com/krzysztofzablocki/Sourcery) ⭐ 8,018 | 🐛 94 | 🌐 Swift | 📅 2026-06-11 – Meta-programming for Swift, stop writing boilerplate code.
...
* [Swifter](https://github.com/LiveUI/Swifter) ⭐ 44 | 🐛 0 | 🌐 Swift | 📅 2018-04-06 – A macOS tool to help you manage your Xcode projects and give you a quick access to DerivedData folder cleaning and management.
* [Heroku buildpack: curl with HTTP/2 support](https://github.com/vzsg/heroku-buildpack-curl-http2) ⚠️ Archived
...
* ![v3](img/vapor-3.png) [SteamPress](https://github.com/brokenhandsio/SteamPress) ⭐ 379 | 🐛 1 | 🌐 Swift | 📅 2022-12-03 – A Blogging Engine and Platform written in Swift for use with the Vapor Framework.
